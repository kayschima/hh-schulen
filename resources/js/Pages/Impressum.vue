...
<template>
    <Head title="Hamburger Schulen - Impressum"/>
    ...
    <div class="max-w-7xl mx-auto">
        ...
        <main class="px-4 pb-4 text-xs">
            ...
            <p class="mt-4">
                <span class="underline font-bold">Haftungsausschluss: <br></span>
            ...
            <p class="mt-4">
                <span class="underline font-bold">Haftung für Links<br></span>
            ...
            <p class="mt-4">
                <span class="underline font-bold">Urheberrecht<br></span>
